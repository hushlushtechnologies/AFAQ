...
const Roadmap = () => {
  ...
  return (
    <>
      ...
      <div
        className="container-fluid py-5 position-relative text-center text-white"
        style={{
          backgroundImage: `url('/images/d.png')`,
          backgroundSize: "cover", // ensures full cover
          backgroundRepeat: "no-repeat",
          backgroundPosition: "center",
          minHeight: "120vh", // give it height (adjust as needed)
          width: "100%",
        }}
      >
