...
export default function Header({ variant }) {
          ...
          <div className="cs_top_header_in">
            <div className="cs_top_header_left">
              <ul className="cs_top_nav d-flex flex-wrap align-items-center cs_fs_12 text-white m-0 p-0">
                <li>
                  <b className="fw-medium text-white">Address:</b> crystal plaza Sharjah al majaz 1 Dubai, UAE
                </li>
                <li>
                  <Link to="mailto:info@afaqmanagement.com">info@afaqmanagement.com</Link>
                </li>
              </ul>
            </div>
  ...
  <Link className="cs_site_branding" to="/">
    <img src="/logo.png" alt="Logo" className="img-fluid" style={{ maxWidth: "120px", height: "auto" }} />
  </Link>
